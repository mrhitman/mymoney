...
import { Avatar, Button, Card, Col, Divider, List, Row, Typography } from "antd";
        ...
        <Col key={wallet.id} id={wallet.id} {...layout}>
            <Card hoverable style={{ width: 300, marginTop: 16 }} loading={loading}>
                <Link to={`/operations/${wallet.id}`}>
                    ...
                    />
                    <Row style={{ float: "right", marginTop: 14, marginBottom: 8, marginRight: 8 }} >
                        <Col>
                            <Button icon={<EditOutlined />} onClick={e => { e.preventDefault() }} />
                            <Button icon={<DeleteOutlined />} onClick={e => { e.preventDefault() }} />
                        </Col>
                    </Row>
                    <Divider />
                    <List
